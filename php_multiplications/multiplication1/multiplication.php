...
<body>
        <div class="container mt-5" style="background-color:#510a41;">
               <div class="row mt-2">
                  <div class="col-2"><a href="../index.php" class="btn btn-dark animated infinite tada delay-1s">Acceuil</a></div>
   ...
   <div class="container jumbotron mt-5" style="margin-top: 2%!important; background-color: #510a41;">
   	  <div class="card card-secondary">
   	  	...
   	  	<div class="card-body">
              ...
              <div class="mt-4">
                <a href="multiplication.php"><input style="border-radius: 15px; background-color: black; color: white;" type="submit" name="valider" value="Reprendre"></a>
                </div>
   	  		</form>
   	  	</div>
   	  </div>
